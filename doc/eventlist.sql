...
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '경복궁 수문장 교대의식', '경복궁 광화문', 1, '2024-01-01', '2024-12-31', 
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT  r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2024 갑진년 수문장 세화 나눔', '경복궁 광화문 수문장청', 2, '2024-02-09', '2024-02-10', 'https://www.chf.or.kr/short/tYMO',
...
insert into event_list values(
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '덕수궁'),
'행사', '2023년 밤의 석조전(하반기)', '덕수궁 석조전', 3, '2023-10-06', '2023-11-02',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023 궁궐 호위군 사열의식 첩종 疊鐘', '경복궁 흥례문 앞', 2, '2023-10-20', '2023-10-22',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '[2023 가을 궁중문화축전] 아티스트가 사랑한 궁', '경복궁 집옥재', 1, '2023-10-17', '2023-10-18',
...
insert into event_list values(
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창경궁'),
'행사', '[2023 가을 궁중문화축전] 인문학 콘서트 창경궁, 우리의 유산', '창경궁 통명전', 1, '2023-10-16', '2023-10-17',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '[2023 가을 궁중문화축전] 판소리로 듣는 궁 이야기', '경복궁 흥복전', 2, '2023-10-13', '2023-10-14', 'https://www.chf.or.kr/short/w7L3',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '덕수궁'),
'행사', '2023 대한제국 외국공사 접견례', '덕수궁', 2, '2023-10-20', '2023-10-22',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '궁궐일상모습 재현 및 체험-왕가의 산책', '경복궁 일원', 2, '2023-10-08', '2023-10-13',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023년 수라간 시식공감(하반기)', '경복궁', 1, '2023-10-20', '2023-10-28', 
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023 고궁음악회 - 풍류에 그루브를 더하다', '경복궁 수정전', 1, '2023-10-13', '2023-10-20', 
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023 고궁음악회 - 발레x수제천', '경복궁 집옥재', 1, '2023-10-12', '2023-10-14', 
...
insert into event_list values(
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창덕궁'),
'행사', '사회적 배려 대상자 초청 ‘창덕궁 달빛기행’ 모집(연장)', '창덕궁', 2, '2023-10-26', '2023-10-27', 
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '사회적 배려 대상자 초청 ‘경복궁 시식공감’ 모집', '경복궁', 2, '2023-10-23', '2023-10-28', 
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023년 경복궁 생과방(하반기)', '경복궁 생과방', 4, '2023-09-07', '2023-10-21',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '사회적 배려 대상자 초청 ‘경복궁 별빛야행’ 모집', '경복궁', 2, '2023-10-05', '2023-10-07',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023 경복궁 별빛야행(하반기)', '경복궁', 2, '2023-09-08', '2023-10-08',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창덕궁'),
'행사', '2023년 창덕궁 달빛기행(하반기)', '창덕궁', 2, '2023-09-07', '2023-10-22', 
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023 수라간 시식공감', '경복궁', 1, '2023-05-25', '2023-06-04',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023년 경복궁 생과방 - 경복궁에서 마주한 특별한 시간', '경복궁 생과방', 4, '2023-04-20', '2023-06-28',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창덕궁'),
'행사', '2023년 창덕궁 달빛기행', '창덕궁', 2, '2023-04-13', '2023-06-04',
...
insert into event_list values(
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '종묘'),
'행사', '2023 종묘대제', '종묘 영녕전 및 종묘 일원', 1, '2023-05-07', '2023-05-07',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023년 수문장 교대의식 어린이날 특별행사', '경복궁 협생문 밖 공개훈련장 일원', 2, '2023-05-05', '2023-05-05', 'https://www.chf.or.kr/short/vdV2',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '덕수궁'),
'행사', '[고궁음악회] 풍류에 힙(Hip)을 더하다', '덕수궁 즉조당 앞마당', 1, '2023-05-05', '2023-05-28',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '[고궁음악회] 풍류에 그루브(Groove)를 더하다', '경복궁 수정전', 2, '2023-04-29', '2023-05-06', 'https://www.chf.or.kr/short/bqR3',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '덕수궁'),
'행사', '[궁중문화축전] 오얏꽃 개화만리', '덕수궁 정관헌', 3, '2023-05-04', '2023-05-06',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '종묘'),
'행사', '2023년 종묘 묘현례 - 1703 조선의 왕비 문안드립니다', '종묘 영녕전', 2, '2023-04-28', '2023-05-01',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창덕궁'),
'행사', '[궁중문화축전] 낭만궁궐 기담극장', '창덕궁 낙선재', 2, '2023-04-30', '2023-05-03',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '[궁중문화축전] 어린이 궁중문화축전-어린이 과거시험', '경복궁', 1, '2023-05-05', '2023-05-07',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창경궁'),
'행사', '[궁중문화축전] 시간여행-영조, 홍화문을 열다', '창경궁 일원', 2, '2023-05-02', '2023-05-02', 
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '[궁중문화축전] 고궁뮤지컬-세종 1446', '경복궁 근정전', 1, '2023-04-29', '2023-05-02',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창경궁'),
'행사', '2023년 창경궁 야연', '창경궁 문정전', 1, '2023-05-02', '2023-05-19',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023 경복궁 별빛야행', '경복궁', 2, '2023-04-15', '2023-05-13',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '덕수궁'),
'행사', '밤의 석조전 - 오얏꽃 흩날리는 봄밤, 대한제국 황실의 문이 열립니다.', '덕수궁 석조전', 3, '2023-04-11', '2023-05-11',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창경궁'),
'행사', '[궁중문화축전] 어명이오! 궁중 새내기 모여라', '창경궁 일원', 3, '2023-05-03', '2023-05-05',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023년 봄 궁중문화축전 개막제', '경복궁(*사전행사 : 창경궁)', 1, '2023-04-28', '2023-04-28',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '창덕궁'),
'행사', '사회적 배려 대상자 초청 ‘창덕궁 달빛기행’ 모집', '창덕궁', 2, '2023-04-29', '2023-04-30', 'https://www.chf.or.kr/short/8EV5',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023 전국 수문장 임명의식 - 국왕께서 친히 전국의 수문장을 낙점하다!', '경복궁 흥례문 일원', 1, '2023-03-26', '2023-03-26',
...
eventlist_id_seq.nextval, 
(SELECT DISTINCT r.royal_id FROM royal r LEFT JOIN event_list e ON r.royal_id = e.royal_id WHERE r.royal_name = '경복궁'),
'행사', '2023년 수문장 세화 나눔', '경복궁 광화문 수문장청', 2, '2024-01-21', '2024-01-24', 'https://www.chf.or.kr/short/AcDf',
