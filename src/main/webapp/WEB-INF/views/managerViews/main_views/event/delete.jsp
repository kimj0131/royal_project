...
<head>
	...
	<title>서울고궁안내 - 관리자>행사관리>취소</title>
...
<body id="page-top">
						...
						<div class="col-lg-12">
							<div class="card mb-4">
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">행사 취소</h6>
								</div>
								<div class="card-body">
									<form action="/royal/manage/main/event/post/delete" method="post">
										<div class="form-group">
											<input type="text" class="form-control" id="event_id" name="event_id" placeholder="취소할 행사 ID">
										</div>
	...
	<!-- Individual JS -->
	<c:url value="/resources/js/manager/event/delete.js" var="deleteJS" />
