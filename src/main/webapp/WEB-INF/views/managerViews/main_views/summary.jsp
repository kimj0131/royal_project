...
<head>
	...
	<c:url value="/resources/vendor/manager/fontawesome-free/css/all.min.css" var="allMinCss" />
	<c:url value="/resources/vendor/manager/bootstrap/css/bootstrap.min.css" var="bootstrapMinCss" />
	<c:url value="/resources/css/manager/ruang-admin.min.css" var="ruangAdminMinCss" />

	<link href="${allMinCss}" rel="stylesheet" type="text/css">
	<link href="${bootstrapMinCss}" rel="stylesheet" type="text/css">
	<link href="${ruangAdminMinCss}" rel="stylesheet">
...
<body id="page-top">
			...
			<li class="nav-item">
				...
				<div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="form_advanceds.html">FormAdvanceds</a>
					</div>
				</div>
			</li>
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow mx-1">
							<a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-tasks fa-fw"></i> 
	...
	<c:url value="/resources/vendor/manager/jquery/jquery.min.js" var="jqueryMinJs" />
	<c:url value="/resources/vendor/manager/bootstrap/js/bootstrap.bundle.min.js" var="bootstrapBundleMinJs" />	
	<c:url value="/resources/vendor/manager/jquery-easing/jquery.easing.min.js" var="jqueryEasingMinJs" />	
	<c:url value="/resources/js/manager/ruang-admin.min.js" var="ruangAdminMinJs" />	
	...
	<script src="${ruangAdminMinJs}"></script>
