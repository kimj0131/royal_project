...
<head>
	...
	<title>서울고궁안내 - 관리자>공지사항>수정</title>
						...
						<div class="col-lg-12">
							<div class="card mb-4">
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 id="selected_notice_title" class="m-0 font-weight-bold text-primary">수정할 공지사항을 아래 목록에서 선택해주세요</h6>
								</div>
								<div class="card-body">
						...
						<div class="col-lg-12">
							<div class="card mb-4">
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									...
									<span style="font-size: 15px; font-weight: bold; ">※ 수정할 공지사항을 아래 목록에서 선택해주세요.</span>
								</div>
