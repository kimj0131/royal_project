		...
		<div class="sub_con_section">
			...
			<div class="palace_intro_wrap">
				...
				<div class="txt_wrap">
					...
					<div class="tit_wrap">창경궁(昌慶宮)은 성종이 세 명의 대비를 위해 옛 수강궁에 창건한
						궁이다.</div>
					<div class="txt_wrap">
						창경궁은 원래 1418년(세종 즉위) 세종이 상왕 태종을 위해 창건한 수강궁(壽康宮)이 있던 자리이다. 이후
						1483년(성종 14) 성종이 세 명의 대비(세조의 왕비 정희왕후, 덕종의 왕비 소혜왕후, 예종의 왕비 안순왕후)를
						위해 수강궁을 크게 확장하고 궁의 이름을 창경궁이라 하였다. 창경궁은 창덕궁과 경계 없이 동궐(東闕)이라는 하나의 궁궐
			...
			<div class="survey_box">
				<form name="satisForm" id="satisForm" method="post">
					<input type="hidden" name="_csrf"
						...
						type="hidden" name="menuCode" id="menuCode" value="R103010000">
					<div class="top">
						<div class="tit_wrap">
