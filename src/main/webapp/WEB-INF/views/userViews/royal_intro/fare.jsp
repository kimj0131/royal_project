...
<c:url value="/resources/css/fare.css" var="fareCSS" />
	...
	<div class="inner">
		...
		<div class="sub_con_wrap pt0" id="sub_con_wrap">
			<div class="sub_con_section">
					...
					<table class="table bd_table bd th_c">
						...
						<tbody>
							<tr>
								...
								<td>2,400원</td>
								<td>2,400원</td>
								<td>내국인<br> 만25세~만64세<br> 외국인<br> 만19세~만64세
								</td>
							</tr>
							<tr>
								<td rowspan="5">창덕궁</td>
							...
							<tr>
								<td class="bdl" colspan="6" style="text-align: left;"><span
									class="time_red">* 덕수궁 미술관 이용자 : 덕수궁 관람권 및 미술관 관람권 별도 구매</span></td>
							</tr>
							<tr>
								<td colspan="2">종묘</td>
								<td>대인</td>
				...
				<div class="info_txt">
					<ul class="list">
						<li class="item normal"><span class="dot"></span>단체요금은 10인 이상
							적용 (창덕궁 후원은 단체할인 없음)</li>
						<li class="item normal"><span class="dot"></span>「문화재보호법」 및
							「궁 관람 등에 관한 규정」개정에 따라 기초단체 지역주민(각 궁능 해당 소재지)이 신분증 등 증빙 제시시 50%
							관람료 할인 적용</li>
						<li class="item normal"><span class="dot"></span>단, 중복 할인 제외
							(예 : 단체요금에 50% 관람료 할인 중복 적용 불가)</li>
					</ul>
				</div>
			</div>
			<!-- [E] sub_con_section -->
			...
			<div class="sub_con_section">
						...
						<tbody data-pe_b-o-c="">
							<tr>
								...
								<td>
									<ul>
										...
										<li>- 환불 : 구입한 궁에서만 환불가능<br> (단, 한군데라도 절취시 환불 불가능)
										</li>
									</ul>
								</td>
							</tr>
							<tr>
								<td colspan="3">* 단, 창덕궁 후원은 입장인원 한정으로 관람권이 아닌 교환권입니다.<br>
									그러므로 후원관람권으로 선착순 교환하셔야하며 성수기에는 빨리 매진됩니다.<br> (관람 6일 전 오전
									10시부터 1일 전까지 온라인에서 예매(결제) 후 매표소에서 환불받거나, 당일 09시부터 관람권으로 교환)<br>
									* 4~5월과 10~11월 주말은 매우 빨리 매진됩니다. <br></td>
							</tr>
							<tr>
				...
				<div class="sub_con_section">
					...
					<div class="box_wrap">
						<ul class="list">
							<li class="item dot_item"><span class="dot"></span>만 6세 이하
								어린이, 만 7세~만&nbsp;24세 이하 청소년, 만 65세 이상 국민(신분증 지참)</li>
							<li class="item dot_item"><span class="dot"></span>만 18세 이하
								및 만 65세 이상 외국인</li>
							...
							<li class="item dot_item"><span class="dot"></span>공무수행을 위하여
								출입하는 자, 한복을 착용한 자</li>
							...
							<li class="item dot_item"><span class="dot"></span>독립유공자 및
								배우자, 애국지사, 선순위 유족</li>
							<li class="item dot_item"><span class="dot"></span>국가유공가 및
								배우자, 상이(장애)1~3급자와 동행하는 보조인 1인, 선순위 유족</li>
							<li class="item dot_item"><span class="dot"></span>보훈보상대상자 및
								배우자, 선순위 유족 (「보훈보상대상자 지원에 관한 법률」 제54조의5(고궁 등의 이용 지원) 2023.7.18.
								시행</li>
							...
							<li class="item dot_item"><span class="dot"></span>「효행 장려 및
								지원법」에 따른 효행우수자
								<ul class="list">
									<li class="item">- 「국민기초생활보장법」 에 의한 기초생활수급자</li>
								</ul></li>
							<li class="item dot_item"><span class="dot"></span>차상위계층 중
								자활급여, 건강보험료 경감대상, 장애수당, 한부모 가정 중 하나 이상의 급여를 받고 있는 자 및 기타
							...
							<li class="item dot_item"><span class="dot"></span>국가무형국가유산&nbsp;보유자
								및 전수교육조교</li>
							<li class="item dot_item"><span class="dot"></span>국가유산위원 및
								전문위원</li>
							...
							<li class="item dot_item"><span class="dot"></span>해당 지자체 주민
								50% 일반관람료 할인
								<ul class="list">
					...
					<div class="wrap table_wrap">
						<table class="table bd_table bd th_c">
							...
							<tbody>
								...
								<tr>
									<th>국가유공자 유족</th>
									<td>전몰군경 유족, 순직군경 유족<br> 4·19혁명사망자유족<br> 순직공무원
										유족<br> 국가사회발전 특별공로순직자 유족
									</td>
									<td>본인</td>
								</tr>
								<tr>
