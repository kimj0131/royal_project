			...
			<ul class="list">
				<li class="menu"><a href="/royal/palace/deoksuhistory">
						<div class="banner_img">
							<img
								src="../resources/image/royal_inner/main/deoksu/bg_menu04_01.jpg"
								alt="이미지" />
						</div>
				...
				<li class="menu"><a
					href="/royal/palace/royalInner?palace=덕수궁&royalId=4"> 덕수궁 내부
						<div class="banner_img">
							<img
								src="../resources/image/royal_inner/main/deoksu/bg_menu04_02.jpg"
								alt="이미지" />
						</div>
						<div class="banner_txt">
				...
				<li class="menu"><a href="/royal/palace/viewing_time">
						<div class="banner_img">
							<img
								src="../resources/image/royal_inner/main/deoksu/bg_menu04_03.jpg"
								alt="이미지" />
						</div>
						<div class="banner_txt">
				...
				<li class="menu"><a href="/royal/palace/reservation">
						<div class="banner_img">
							<img
								src="../resources/image/royal_inner/main/deoksu/bg_menu04_04.jpg"
								alt="이미지" />
						</div>
						<div class="banner_txt">
