	...
	<div id="divfull">
		...
		<div id="leftDiv">
			...
			<div id="left4">
				...
				<div class="tip_intro">
					색색의 고운 우리나라 전통의상 한복을 입고 고궁을 방문하면<br> 입장료가 무료! 궁궐 근처 한복 대여점이
					많으니 한복을 입고<br>조선 시대로 여행을 떠나보길 추천한다.
				</div>
			</div>
